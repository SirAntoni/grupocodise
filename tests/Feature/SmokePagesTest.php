...
it('todas las páginas del sistema responden correctamente', function () {
    ...
    $routes = [
        ...
        'guia pdf descarga' => route('guias.pdf', [$issuedGuide, 'descargar' => 1]),
        ...
        'factura pdf descarga' => route('facturas.pdf', [$accepted, 'descargar' => 1]),
        ...
        'cotización pdf' => route('cotizaciones.pdf', $quotation),
        'cotización pdf descarga' => route('cotizaciones.pdf', [$quotation, 'descargar' => 1]),
        ...
        'reporte de facturas' => route('reportes.facturas'),
        'reporte de facturas semanal' => route('reportes.facturas', ['periodType' => 'semanal']),
        'reporte de facturas rango libre' => route('reportes.facturas', ['periodType' => 'libre']),
        'reporte de facturas excel' => route('reportes.facturas.excel', ['year' => now()->year, 'month' => now()->month, 'fortnight' => 1]),
